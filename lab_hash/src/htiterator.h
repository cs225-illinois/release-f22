...
/**
 * An abstract iterator implementation class. Used by the HashTable iterator
 * class in order to be polymorphic across hash table implementations. Derived
 * classes of HashTable should implement their own HTIteratorImpl and use it
 * to construct their begin() and end() iterators.
 */
template <class K, class V>
